...
def main():
    ...
    if args.model_train == "efficientnet-b0":
        netD = EfficientNet.from_pretrained(
            "efficientnet-b0", num_classes=args.num_classes
        )
    elif args.model_train == "efficientnet-b1":
        netD = EfficientNet.from_pretrained(
            "efficientnet-b1", num_classes=args.num_classes
        )
    elif args.model_train == "efficientnet-b2":
        netD = EfficientNet.from_pretrained(
            "efficientnet-b2", num_classes=args.num_classes
        )
    elif args.model_train == "efficientnet-b3":
        netD = EfficientNet.from_pretrained(
            "efficientnet-b3", num_classes=args.num_classes
        )
        ...
        netD = EfficientNet.from_pretrained(
            "efficientnet-b5", num_classes=args.num_classes
        )
    elif args.model_train == "efficientnet-b6":
        netD = EfficientNet.from_pretrained(
            "efficientnet-b6", num_classes=args.num_classes
        )
    elif args.model_train == "efficientnet-b7":
        netD = EfficientNet.from_pretrained(
            "efficientnet-b7", num_classes=args.num_classes
        )
    ...
    )  # don't set it too high, will run out of RAM
