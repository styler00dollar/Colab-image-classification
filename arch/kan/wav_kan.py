# https://github.com/IvanDrokin/torch-conv-kan/blob/851ae0ca05632f8e8f1785e08d68ba88109afbd0/kan_convs/wav_kan.py
"""
...
class WaveletConvND(nn.Module):
    def __init__(
        ...
        self.wavelet_out = conv_class(
            output_dim, output_dim, 1, 1, 0, dilation, groups=1, bias=False
        )
