# https://github.com/IvanDrokin/torch-conv-kan/blob/851ae0ca05632f8e8f1785e08d68ba88109afbd0/kan_convs/kacn_conv.py
import torch
    ...
    def __init__(
        ...
        **norm_kwargs
        ...
        self.register_buffer(
            "arange", torch.arange(0, degree + 1, 1).view(*arange_buffer_size)
        )
