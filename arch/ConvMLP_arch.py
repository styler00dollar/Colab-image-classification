"""
4-Dez-21
https://github.com/SHI-Labs/Convolutional-MLPs/blob/master/src/classification/__init__.py
https://github.com/SHI-Labs/Convolutional-MLPs/blob/master/src/convmlp.py
https://github.com/SHI-Labs/Convolutional-MLPs/blob/master/src/utils/tokenizer.py
...
def _convmlp(arch, pretrained, progress, classifier_head, blocks, dims, mlp_ratios, num_classes, *args, **kwargs):
    model = ConvMLP(blocks=blocks, dims=dims, mlp_ratios=mlp_ratios,
                    classifier_head=classifier_head, num_classes=num_classes, *args, **kwargs)
...
def convmlp_s(pretrained=False, progress=False, classifier_head=True, num_classes=3, *args, **kwargs):
...
def convmlp_m(pretrained=False, progress=False, classifier_head=True, num_classes=3, *args, **kwargs):
...
def convmlp_l(pretrained=False, progress=False, classifier_head=True, num_classes=3, *args, **kwargs):
...
@register_model
def convmlp_s_classification(num_classes=3, *args, **kwargs):
    return convmlp_s(classifier_head=True, num_classes=num_classes, *args, **kwargs)


@register_model
def convmlp_m_classification(num_classes=3, *args, **kwargs):
    return convmlp_m(classifier_head=True, num_classes=num_classes, *args, **kwargs)


@register_model
def convmlp_l_classification(num_classes=3, *args, **kwargs):
    return convmlp_l(classifier_head=True, num_classes=num_classes, *args, **kwargs)
"""