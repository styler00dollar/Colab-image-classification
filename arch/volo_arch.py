...
@register_model
def volo_d1(pretrained=False, num_classes=3, **kwargs):
    """
...
@register_model
def volo_d2(pretrained=False, num_classes=3, **kwargs):
    """
...
@register_model
def volo_d3(pretrained=False, num_classes=3, **kwargs):
    """
...
@register_model
def volo_d4(pretrained=False, num_classes=3, **kwargs):
    """
...
@register_model
def volo_d5(pretrained=False, num_classes=3, **kwargs):
    """
