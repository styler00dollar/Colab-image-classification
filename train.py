...
def main():
    ...
    dm = DataModule(training_path=args.training_path, validation_path=args.validation_path, test_path=args.validation_path, num_workers = 16, size = 256, batch_size=1, means=args.means, std=args.std)
